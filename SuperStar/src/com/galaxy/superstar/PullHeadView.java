...
public class PullHeadView extends ViewGroup{
	...
	private void initView(Context context){
		...
		LayoutInflater.from(context).inflate(R.layout.pull_to_refresh_header,this, true);
		...
		setBackgroundColor(getResources().getColor(R.color.chat_bg));
	}
	...
	private String getLastTimeLable() {
		if(mTimeTag != null){
			...
			String format = mContext.getString(R.string.string_update_time, "0000-00-00");//StringUtil.getPublishTime(time));
			return format;
		}
		return null;
	}
